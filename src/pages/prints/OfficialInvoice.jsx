...
const OfficialInvoice = ({ token, invoiceNo, printName, urls, evn, ApiVer }) => {
                                                ...
                                                result?.resultArray?.map((e, i) => {
                                                    ...
                                                    return (
                                                        <div className='d-flex w-100 brl_jts brr_jts brb_jts fs_jts pbia_jts' key={i}>
                                                            ...
                                                            <div className='col4_jts d-flex align-items-start justify-content-end p-1 brr_jts'>
                                                                
                                                                {formatAmount((e?.UnitCost / result?.header?.CurrencyExchRate))}
                                                            </div>

                                                            <div className='col4_jts d-flex align-items-start justify-content-end p-1 brr_jts' style={{width:"10%"}}>
                                                                 
                                                                {formatAmount((e?.DiscountAmt / result?.header?.CurrencyExchRate))}
                                                            </div>

                                                            <div className='col4_jts d-flex align-items-start justify-content-end p-1' style={{width:"16%"}}>
                                                                <span className='pe-1'
