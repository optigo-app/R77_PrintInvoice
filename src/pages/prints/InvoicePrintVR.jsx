...
import "../../assets/css/prints/jewellaryinvoiceprintVR.css";
...
const InvoicePrintVR = ({
        ...
        data?.BillPrint_Json2?.forEach((e) => {
            if (e?.MasterManagement_DiamondStoneTypeid === 1) {
                let findDiamond = diamondDetail?.findIndex(
                    (ele) =>
                        ele?.MaterialTypeName === e?.MaterialTypeName &&
    ...
    const mergeByKey = ({
        ...
        valueFields = ["metalWastage", "isRateOnPcs", "grosswt", "StockBarcode", "GroupJob", "Hid", "metalWastage1", "MaterialTypeName"]   // <-- added
    }) => {
                        ...
                        {result?.header?.CompanyTollFreeNo} */}
                                    ...
                                    <div className="pt-1 no_break">
                                        <div className="border d-flex">
                                            <div className={`${style?.srNoJewerryRetailInvoicePrint} border-end p-1 d-flex align-items-center justify-content-center`} style={{ width: "5%" }}>
                                                <p className="fw-bold">Sr#</p>
                                            </div>
                                            <div className={`${style?.productJewerryRetailInvoicePrint} border-end p-1 fw-bold d-flex align-items-center justify-content-center`} style={{ width: "15%" }}>
                                                <p className="fw-bold"> Description</p>
                                            </div>
                                            <div className={`${style?.materialJewerryRetailInvoicePrint}`} style={{ width: "80%" }}>
                                                <div className="d-flex">
                                                    <div className={`col-2 d-flex align-items-center justify-content-center`} style={{ width: "13.66%" }}>
                                                        <p className="fw-bold p-1">Detail</p>
                                                    </div>
                                                    <div className={`col-2 d-flex align-items-center justify-content-center `} style={{ width: "8%" }}>
                                                        <p className="fw-bold p-1">HSN</p>
                                                    </div>
                                                    <div className={`col-2 d-flex align-items-center justify-content-center `} style={{ width: "5%" }}>
                                                        <p className="fw-bold p-1">QTY</p>
                                                    </div>
                                                    <div className={`col-2 d-flex align-items-center justify-content-center  p-1 flex-column`} style={{ width: "10%" }}>
                                                        <p className="fw-bold">Gross. Wt</p>
                                                    </div>
                                                    <div className={`col-2 d-flex align-items-center justify-content-center `} style={{ width: "8%" }}>
                                                        <p className="fw-bold p-1">Net Wt.</p>
                                                    </div>
                                                    <div className={`col-2 d-flex align-items-center justify-content-center `} style={{ width: "7%" }}>
                                                        <p className="fw-bold p-1">Pcs</p>
                                                    </div>
                                                    <div className={`col-2 d-flex align-items-center justify-content-center `} style={{ width: "11%" }}>
                                                        <p className="fw-bold p-1">Wt.</p>
                                                    </div>
                                                    <div className={`col-2 d-flex align-items-center justify-content-center`} style={{ width: "12%" }}>
                                                        <p className="fw-bold p-1">Rate</p>
                                                    </div>
                                                    <div className={`col-2 d-flex align-items-center justify-content-center`} style={{ width: "12%" }}>
                                                        <p className="fw-bold p-1">Wastage</p>
                                                    </div>
                                                    <div className={`col-2 d-flex align-items-center justify-content-center`} style={{ width: "12%" }}>
                                        ...
                                        result?.resultArray?.map((e, i) => {
                                            ...
                                            const findingLines = Array.isArray(e?.finding) && e.finding.length > 0 ? e.finding : [];

                                      
                                            const MaterialLine = ({ lineKey, detail, hsn, qty, grossWt, netWt, pcs, wt, rate, wastage, amount }) => (
                                                <div className="d-flex" key={lineKey}>
                                                    <div className="col-2 d-flex align-items-center" style={{ width: "13.66%" }}>
                                                        <p className="p-1 lh-1">{detail}</p>
                                                    </div>
                                                    <div className="col-2 d-flex align-items-center justify-content-center" style={{ width: "8%" }}>
                                                        <p className="p-1 lh-1">{hsn}</p>
                                                    </div>
                                                    <div className="col-2 d-flex align-items-center justify-content-center" style={{ width: "5%" }}>
                                                        <p className="p-1">{qty}</p>
                                                    </div>
                                                    <div className="col-2 d-flex align-items-center justify-content-end" style={{ width: "10%" }}>
                                                        <p className="p-1 text-end lh-1">{grossWt}</p>
                                                    </div>
                                                    <div className="col-2 d-flex align-items-center justify-content-end" style={{ width: "8%" }}>
                                                        <p className="p-1 text-end lh-1">{netWt}</p>
                                                    </div>
                                                    <div className="col-2 d-flex align-items-center justify-content-center" style={{ width: "7%" }}>
                                                        <p className="p-1">{pcs}</p>
                                                    </div>
                                                    <div className="col-2 d-flex align-items-center justify-content-center" style={{ width: "11%" }}>
                                                        <p className="p-1">{wt}</p>
                                                    </div>
                                                    <div className="col-2 d-flex align-items-center justify-content-end" style={{ width: "12%" }}>
                                                        <p className="p-1 text-end lh-1">{rate}</p>
                                                    </div>
                                                    <div className="col-2 d-flex align-items-center justify-content-center" style={{ width: "12%" }}>
                                                        <p className="p-1">{wastage}</p>
                                                    </div>
                                                    <div className="col-2 d-flex align-items-center justify-content-end" style={{ width: "12%" }}>
                                                        <p className="p-1 text-end lh-1">{amount}</p>
                                                    </div>
                                                </div>
                                            );
                                            ...
                                            return (
                                                <React.Fragment key={i}>
                                                    <div className="border-start border-end d-flex no_break">
                                                        {/* Sr# */}
                                                        <div className={`${style?.srNoJewerryRetailInvoicePrint} border-end p-1 d-flex align-items-center justify-content-center`} style={{ width: "5%" }}>
                                                            <p className="">{i + 1}</p>
                                                        </div>
                                                        ...
                                                        {/* Description */}
                                                        <div className={`${style?.productJewerryRetailInvoicePrint} border-end p-1`} style={{ width: "15%" }}>
                                                            ...
                                                            {e?.HUID !== "" && (
                                                                <p style={{ wordBreak: "normal" }} className={`text-center ${!image && "pt-3"}`}>
                                                                    HUID-{e?.HUID}
                                                                </p>
                                                            )}
                                                        </div>
                                                            ...
                                                            <div className="h-100">
                                                                {metalLines?.map((d, idx) => (
                                                                    <MaterialLine
                                                                        ...
                                                                        hsn={e?.HSNNo}
                                                                        qty={d.IsPrimaryMetal === 1 ? e?.BulkPurchaseQTY : ""}
                                                                        grossWt={
                                                                            d?.GroupJob
                                                                                ? d?.GroupJob == d?.StockBarcode
                                                                                    ? d.IsPrimaryMetal === 1
                                                                        ...
                                                                        netWt={NumberWithCommas(
                                                                            d?.IsPrimaryMetal === 1 ? d?.RMwt - totalFindingRMwt : d?.RMwt,
                                                                            3
                                                                        )}
                                                                        pcs=""
                                                                        wt=""
                                                                        rate={NumberWithCommas(d?.Rate / result?.header?.CurrencyExchRate, 2)}
                                                                        wastage={
                                                                            d.IsPrimaryMetal === 1
                                                                                ? NumberWithCommas(d?.metalWastage1, 2)
                                                                ...
                                                                {diamondLines?.map((d, idx) => (
                                                                    <MaterialLine
                                                                        lineKey={`diamond-${i}-${idx}`}
                                                                        detail={`${d?.MaterialTypeName || ""} DIAMOND`}
                                                                        hsn=""
                                                                        qty=""
                                                                        grossWt=""
                                                                        netWt=""
                                                                        pcs={NumberWithCommas(Number(d.Pcs) || 0)}
                                                                        wt={`${NumberWithCommas(Number(d.RMwt) || 0, 2)} ctw`}
                                                                        rate={NumberWithCommas(Number(d.Rate) || 0, 2)}
                                                                        wastage=""
                                                                        amount={NumberWithCommas(d?.isRateOnPcs == 1 ? d?.Pcs * d?.Rate : d?.RMwt * d?.Rate, 2)}
                                                                    />
                                                                ))}

                                                                {colorstoneLines?.map((d, idx) => (
                                                                    <MaterialLine
                                                                        lineKey={`colorstone-${i}-${idx}`}
                                                                        detail={`${d?.MaterialTypeName || ""} COLORSTONE`}
                                                                        hsn=""
                                                                        qty=""
                                                                        grossWt=""
                                                                        netWt=""
                                                                ...
                                                                {miscLines?.map((d, idx) => (
                                                                    <MaterialLine
                                                                        lineKey={`misc-${i}-${idx}`}
                                                                        detail={`${d?.MaterialTypeName || ""} MISC`}
                                                                        hsn=""
                                                                        qty=""
                                                                        grossWt=""
                                                                        netWt=""
                                                                        pcs={NumberWithCommas(Number(d?.Pcs) || 0)}
                                                                        wt={`${NumberWithCommas(Number(d?.RMwt) || 0, 2)} gm`}
                                                                        rate={NumberWithCommas(Number(d?.Rate) || 0, 2)}
                                                                        wastage=""
                                                                        amount={NumberWithCommas(d?.isRateOnPcs == 1 ? d?.Pcs * d?.Rate : d?.RMwt * d?.Rate, 2)}
                                                                    />
                                                                ...
                                                                {findingLines?.map((d, idx) => (
                                                                    <MaterialLine
                                                                        lineKey={`finding-${i}-${idx}`}
                                                                        detail={
                                                                            <>
                                                                                FINDING <br /> {d?.ShapeName + " " + d?.QualityName}
                                                                            </>
                                                                        }
                                                                        hsn=""
                                                                        qty=""
                                                                        ...
                                                                        pcs={NumberWithCommas(Number(d?.Pcs) || 0)}
                                                                        wt={`${NumberWithCommas(Number(d?.RMwt) || 0, 2)} gm`}
                                                                        rate={NumberWithCommas(Number(e?.primary_metal_rate) || 0, 2)}
                                                                        wastage={NumberWithCommas(d.metalWastage, 2)}
                                                                        amount={NumberWithCommas(d?.RMwt * e?.primary_metal_rate, 2)}
                                                                    />
                                                                ))}
                                                                ...
                                                                {e?.MakingAmount > 0 && (
                                                                    <MaterialLine
                                                                        ...
                                                                        pcs=""
                                                                        wt=""
                                                                        rate={NumberWithCommas((e?.MaKingCharge_Unit ?? 0) / result?.header?.CurrencyExchRate, 2)}
                                                                        wastage=""
                                                                        amount={NumberWithCommas(e?.MakingAmount, 2)}
                                                                    />
                                                                )}
                                                                ...
                                                                {e?.TotalDiamondHandling > 0 && (
                                                                    <MaterialLine
                                                                        ...
                                                                        rate=""
                                                                        wastage=""
                                                                        amount={NumberWithCommas(e?.TotalDiamondHandling, 2)}
                                                                    />
                                                                )}
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div className="border-start border-end border-bottom d-flex" style={{ borderTop: "none" }}>
                                                        ...
                                                        <div className={`${style?.materialJewerryRetailInvoicePrint}`} style={{ width: "80%" }}>
                                                            <div className="d-flex">
                                                                ...
                                                                <div className="col-2 d-flex align-items-center justify-content-center" style={{ width: "10%" }}>
                                                                    <p className="fw-bold p-1"></p>
                                                                </div>
                                                                <div className="col-2 d-flex align-items-center justify-content-center" style={{ width: "8%" }}>
                                                                    <p className="fw-bold p-1"></p>
                                                                ...
                                                                <div className="col-2 d-flex align-items-center justify-content-end" style={{ width: "12%" }}>
                                                                    <p className="fw-bold p-1 text-end">{NumberWithCommas(e.UnitCost, 2)}</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className={`${style?.minHeight20RetailinvoicePrint3} border-start border-end border-bottom d-flex no_break`}>
                                        ...
                                        <div className={`${style?.productJewerryRetailInvoicePrint} border-end p-1 fw-bold d-flex align-items-center`} style={{ width: "15%" }}>
                                            <p className="fw-bold" style={{ fontSize: "17px" }}>
                                                TOTAL
                                            </p>
                                        </div>
                                        <div className={`${style?.materialJewerryRetailInvoicePrint} d-flex`} style={{ width: "80%" }}>
                                            <div className="d-flex align-items-center justify-content-center" style={{ width: "13.66%" }}></div>
                                            <div className="d-flex align-items-center justify-content-center" style={{ width: "8%" }}></div>
                                            <div className="d-flex align-items-center justify-content-center" style={{ width: "5%" }}></div>
                                            <div className="d-flex align-items-center justify-content-center" style={{ width: "10%" }}></div>
                                            <div className="d-flex align-items-center justify-content-center" style={{ width: "8%" }}></div>
                                            <div className="d-flex align-items-center justify-content-center" style={{ width: "7%" }}></div>
                                            <div className="d-flex align-items-center justify-content-center" style={{ width: "11%" }}></div>
                                            <div className="d-flex align-items-center justify-content-center" style={{ width: "12%" }}></div>
                                            <div className="d-flex align-items-center justify-content-center" style={{ width: "12%" }}></div>
                                            <div className="d-flex align-items-center justify-content-end" style={{ width: "12%" }}>
                                                <p className="fw-bold text-end p-1">
                                                    {NumberWithCommas(result?.mainTotal?.total_unitcost / result?.header?.CurrencyExchRate, 2)}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
