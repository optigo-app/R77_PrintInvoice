...
import "../../assets/css/prints/DetailPrint1PCJSale.css";
...
const DetailPrint1PCJSale = ({ token, invoiceNo, printName, urls, evn, ApiVer }) => {
                ...
                <p className="lhDetailPrint1 pb-1">
                  {json0Data?.customermobileno !== "" && ( `Mobile No : ${json0Data?.customermobileno}` )}
                        ...
                        <div className="d-flex w-100 border-top  recordDetailPrint1 lightGrey detailPrint1L_font_11">
                            <div className="srNoDetailprint11 border-end border-start  border-bottom d-flex justify-content-center align-items-center flex-column" style={{ width: "2%" }}>
                            ...
                            <div className={`diamondDetailPrint1p border-end `} style={{ width: "29.9%", minWidth: "29.9%" }}>
                                <div className="d-grid h-100">
                                    ...
                                    <div className="d-flex border-bottom ">
                                        ...
                                        <p className="fw-bold Wdth d-flex align-items-center justify-content-center border-end " style={{ width: "23%" }}>
                                            Rate
                                        </p>
                                        <p className="fw-bold WdthAmt d-flex align-items-center justify-content-center text-center" style={{ width: "22.95%" }}>
                                            Amount
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className={`metalGoldDetailPrint1p border-end `} style={{ width: "20%", minWidth: "20%" }}>
                                <div className="d-grid h-100">
                                    <div className="d-flex justify-content-center align-items-center border-bottom " >
                                        <p className="fw-bold p-1">Metal </p>
                                    </div>
                                    <div className="d-flex border-bottom ">
                                        <p className="fw-bold Wdth1 border-end d-flex align-items-center justify-content-center" style={{ width: "23%" }}>
                                            Quality
                                        </p>

                                        <p className="fw-bold Wdth1 border-end d-flex align-items-center justify-content-center" style={{ width: "18%" }}>
                                            Nw
                                        </p>
                                        <p className="fw-bold Wdth1 border-end d-flex align-items-center justify-content-center" style={{ width: "27%" }}>
                                            Rate
                                        </p>
                                        <p className="fw-bold Wdth1 d-flex align-items-center justify-content-center" style={{ width: "32%" }}>
                                            Amount
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className={`stoneDetailsPrint1p border-end `} style={{ width: "14.8%", minWidth: "14.8%" }}>
                                <div className="d-grid h-100">
                                    <div className="d-flex justify-content-center border-bottom ">
                                        <p className="fw-bold p-1">Stone & MISC</p>
                                    </div>
                                    <div className="d-flex border-bottom ">

                                        <p className="fw-bold WdthWT border-end  d-flex align-items-center justify-content-center" style={{ width: "26%" }}>
                                            Wt
                                        </p>
                                        <p className="fw-bold Wdth border-end  d-flex align-items-center justify-content-center" style={{ width: "33%" }}>
                                            Rate
                                        </p>
                                        <p className="fw-bold WdthAmt d-flex align-items-center justify-content-center text-center" style={{ width: "39%" }}>
                                            Amount
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="labourAmountDetailPrint1 border-end  border-bottom" style={{ width: "16%" }}>
                                <div className="d-grid h-100">
                                    <div className="border-bottom  d-flex align-items-center justify-content-center">
                                        <p className="text-center fw-bold p-1">Labour & Other Amount</p>
                                    </div>
                                    <div className="d-flex">
                                        <div className="col-5 border-end  d-flex align-items-center justify-content-center" style={{ width: "36%" }}>
                                            <p className="fw-bold ">Charges</p>
                                        </div>
                                        <div className="col-5 border-end  d-flex align-items-center justify-content-center" style={{ width: "30%" }}>
                                            <p className="fw-bold ">Rate</p>
                                        </div>
                                        <div className="col-7 d-flex align-items-center justify-content-center" style={{ width: "33%" }}>
                            ...
                            <div className="totalAmountDetailPrint1 border-end  border-bottom d-flex align-items-center justify-content-center flex-column" style={{ width: "8%" }}>
                                ...
                                return (
                                    <div key={i} className="recordDetailPrint1 Fntdt">
                                        <div className="d-flex w-100">
                                            {/* Sr */}
                                            <div className="srNoDetailprint11 border-end border-start border-bottom pt-1" style={{ width: "2%" }}>
                                            ...
                                            {/* Diamond */}
                                            <div className={`diamondDetailPrint1p border-end position-relative pt-1 paddingLeftDetailPrint1 paddingRightDetailPrint1`} style={{ width: "29.9%", minWidth: "29.9%" }}>
                                                <div className="h-100 paddingBottomTotalDetailPrint1">
                                                        ...
                                                        e?.diamonds.map((ele, ind) => {
                                                            return (
                                                                ...
                                                                >
                                                                    ...
                                                                    <p className="Wdth text-end paddingRightDetailPrint1" style={{ width: "23%" }}>
                                                                        {NumberWithCommas(ele?.Rate, 2)}
                                                                    </p>
                                                                    <p className={`WdthAmt text-end fw-bold`} style={{ width: "22.95%" }}>
                                                    ...
                                                    <div className="d-flex border-bottom position-absolute bottom-0 w-100  border-top totalMinHeightDetailPrint1 lightGrey start-0">
                                                        ...
                                                        <p className="WdthAmtTotl text-end fw-bold d-flex align-items-center justify-content-end paddingRightDetailPrint1l" style={{ width: "30%" }}>
                                            ...
                                            {/* Metal */}
                                            <div className={`metalGoldDetailPrint1p border-end position-relative pt-1 paddingLeftDetailPrint1 paddingRightDetailPrint1`} style={{ width: "20%", minWidth: "20%" }}>
                                                <div className="h-100 paddingBottomTotalDetailPrint1">
                                                    {e?.metal.length > 0 &&
                                                        e?.metal.map((ele, ind) => {
                                                            return (
                                                                <div className={`d-flex`} key={ind}>
                                                                    <p className="Wdth1 paddingRightDetailPrint1 text-break" style={{ width: "23%" }}>
                                                                        {ele?.ShapeName + " " + ele?.QualityName}
                                                                    </p>

                                                                    <p className="Wdth1 text-end paddingRightDetailPrint1" style={{ width: "18%" }}>
                                                                        {fixedValues(e?.NetWt + e?.LossWt, 3)}
                                                                    </p>
                                                                    <p className="Wdth1 text-end paddingRightDetailPrint1" style={{ width: "27%" }}>
                                                                        {NumberWithCommas(ele?.Rate, 2)}
                                                                    </p>
                                                                    <p className={`Wdth1 text-end ${ind > 0 && "fw-bold"}`} style={{ width: "32%" }}>
                                                                        {(NumberWithCommas(ele?.Amount, 2))}
                                                                    </p>
                                                                </div>
                                                            );
                                                    ...
                                                    <div className="d-flex position-absolute bottom-0 w-100 totalMinHeightDetailPrint1 border-top border-bottom lightGrey start-0">
                                                        <p className="Wdth1 paddingRightDetailPrint1" style={{ width: "23%" }}></p>

                                                        <p className="Wdth1 text-end fw-bold d-flex justify-content-end align-items-center paddingRightDetailPrint1" style={{ width: "18%" }}>
                                                            {e?.NetWt !== 0 && fixedValues(e?.NetWt + e?.LossWt, 3)}
                                                        </p>
                                                        <p className="Wdth1 text-end paddingRightDetailPrint1" style={{ width: "27%" }}></p>
                                                        <p className="Wdth1 text-end fw-bold d-flex justify-content-end align-items-center  paddingRightDetailPrint1 " style={{ width: "32%" }}>
                                                            {
                                            ...
                                            {/* Stone */}
                                            <div className={`stoneDetailsPrint1p border-end position-relative pt-1 paddingLeftDetailPrint1 paddingRightDetailPrint1`} style={{ width: "14.8%", minWidth: "14.8%" }}>
                                                <div className="h-100 paddingBottomTotalDetailPrint1">
                                                        ...
                                                        e?.colorstone.map((ele, ind) => {
                                                            return (
                                                                <div className={`d-flex`} key={ind}>
                                                                    ...
                                                                    <p className="WdthWT text-end paddingRightDetailPrint1" style={{ width: "26%" }}>
                                                                        {fixedValues(ele?.Wt, 3)}
                                                                    </p>
                                                                    <p className="Wdth text-end paddingRightDetailPrint1" style={{ width: "33%" }}>
                                                                        {NumberWithCommas(ele?.Rate, 2)}
                                                                    </p>
                                                                    <p
                                                    ...
                                                    <div className="d-flex border-bottom position-absolute bottom-0 w-100  border-top totalMinHeightDetailPrint1 lightGrey paddingRightDetailPrint1 paddingLeftDetailPrint1 start-0">
                                                        <p className="WdthRemnTotl1 paddingRightDetailPrint1 fw-bold d-flex align-items-center justify-content-end" style={{ width: "26%", textAlign: "right" }}>
                                                            {e?.totals?.colorstone?.Wt !== 0 &&
                                                                fixedValues(e?.totals?.colorstone?.Wt, 3)}
                                                        </p>

                                                        <p className="WdthWtTotl text-end fw-bold d-flex align-items-center justify-content-end paddingRightDetailPrint1" style={{ width: "33%" }}>

                                                        </p>

                                                        <p className="WdthAmtTotl text-end fw-bold d-flex align-items-center justify-content-end paddingLeftDetailPrint1  " style={{ width: "39%" }}>
                                            ...
                                            {/* Labour */}
                                            <div className="labourAmountDetailPrint1 border-end position-relative pt-1 paddingLeftDetailPrint1 paddingRightDetailPrint1" style={{ width: "16%" }}>
                                                <div className="d-grid h-100 paddingBottomTotalDetailPrint1" >
                                                    <div className="d-flex ">
                                                        <div className={`otherAmountDetailPrint1p  position-relative paddingLeftDetailPrint1 paddingRightDetailPrint1`} style={{ width: "100%" }}>
                                                ...
                                                <div className="position-absolute bottom-0 w-100 border-bottom  border-top totalMinHeightDetailPrint1 d-flex lightGrey d-flex align-items-center justify-content-end paddingRightDetailPrint1 start-0">
                                                    ...
                                                    <div className="col-7" style={{ width: "66%" }}>
                                            ...
                                            {/* Total */}
                                            <div className="totalAmountDetailPrint1 border-end position-relative pt-1 paddingLeftDetailPrint1 paddingRightDetailPrint1" style={{ width: "8%" }}>
                                                <div className="d-grid h-100 paddingBottomTotalDetailPrint1">
                                                    <div>
                                                        <p className="text-end fw-bold">
                                                            {e?.UnitCost !== 0 &&
                                        ...
                                        {e?.DiscountAmt  > 0 && <div className="d-flex w-100">
                                            ...
                                            <div className={`stoneDetailsPrint1p border-end position-relative border-bottom  lightGrey`} style={{ width: "69.6%", minWidth: "64.3%" }}>
                                            ...
                                            <div className="labourAmountDetailPrint1 border-end  lightGrey border-bottom  " style={{ width: "16%", minWidth: "8%" }}>
                                                <div className=" d-flex justify-end align-items-center h-100">
                                                    <div className="d-flex">
                                            ...
                                            <div className="totalAmountDetailPrint1 border-end  border-bottom d-flex align-tems-center justify-content-end lightGrey" style={{ width: "8%", minWidth: "6.85%" }}>
                        ...
                        <div className="d-flex w-100 border-bottom  border-start recordDetailPrint1 detailPrint1L_font_11">
                            <div className="cgstDetailPrint1 text-end border-end  paddingLeftDetailPrint1 paddingRightDetailPrint1 py-1" style={{ width: "95.5%", minWidth: "92%" }}>
                            ...
                            <div className="cgstTotalDetailPrint1 text-end border-end  paddingLeftDetailPrint1 paddingRightDetailPrint1 py-1" style={{ width: "7.7%" }}>
                        ...
                        <div className="d-flex w-100 recordDetailPrint1 lightGrey Fntdt">
                            ...
                            <div className={`diamondDetailPrint1p border-end  position-relative border-bottom d-flex flex-column justify-content-center paddingLeftDetailPrint1 paddingRightDetailPrint1`} style={{ width: "29.9%", minWidth: "29.9%" }}>
                                <div className="d-flex">
                                    ...
                                    <div className="WdthAmtTotl text-end" style={{ width: "30%" }}>
                                        <p className="fw-bold">
                            ...
                            <div className={`metalTotalDetailPrint1p border-end position-relative border-bottom d-flex flex-column justify-content-center`} style={{ width: "20%", minWidth: "20%", padding: "3px" }}>
                                <div className="d-flex">
                                    <div className="Wdth1 paddingRightDetailPrint1" style={{ width: "23%" }}>
                                        <p className=""></p>
                                    </div>
                                   
                                    <div className="Wdth1 text-end paddingRightDetailPrint1" style={{ width: "18%" }}>
                                        <p className="fw-bold">
                                            {NumberWithCommas(finalD?.mainTotal?.metal?.Wt, 3)}
                                        </p>
                                    </div>
                                    <div className="Wdth1 text-end paddingRightDetailPrint1" style={{ width: "27%" }}>
                                        <p className=""></p>
                                    </div>
                                    <div className="Wdth1 text-end paddingRightDetailPrint1" style={{ width: "32%" }}>
                                        <p className="fw-bold">
                            ...
                            <div className={`stoneDetailsPrint1p border-end position-relative border-bottom d-flex flex-column justify-content-center paddingLeftDetailPrint1 paddingRightDetailPrint1`} style={{ width: "14.8%", minWidth: "14.8%" }}>
                                <div className="d-flex">


                                    <div className="WdthWtTotl text-end d-flex justify-content-end align-items-center h-100  paddingRightDetailPrint1" style={{ width: "26%" }}>
                                        <p className="fw-bold">
                                            {fixedValues(total?.colorStoneWt, 3)}
                                        </p>
                                    </div>
                                    <div className="WdthRemnTotl text-end d-flex justify-content-end align-items-center h-100  paddingRightDetailPrint1" style={{ width: "33%" }}>
                                        <p className="fw-bold"></p>
                                    </div>
                                    <div className="WdthAmtTotl text-end d-flex justify-content-end align-items-center h-100 " style={{ width: "39%" }}>
                                        <p className="fw-bold">
                            ...
                            <div className="labourAmountDetailPrint1 border-end  border-bottom paddingLeftDetailPrint1 paddingRightDetailPrint1" style={{ width: "17%" }}>
                                <div className="d-grid h-100">
                                    <div className="d-flex justify-content-end">
                                        <div className="d-table">
                                            <p className="d-table-cell align-middle text-end h-100 text-end fw-bold">
                                                {NumberWithCommas(total?.labourAmount + finalD?.mainTotal?.miscChargesTotals, 2)}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="totalAmountDetailPrint1 border-end  border-bottom paddingLeftDetailPrint1 paddingRightDetailPrint1" style={{ width: "8.5%" }}>
...
export default DetailPrint1PCJSale;
