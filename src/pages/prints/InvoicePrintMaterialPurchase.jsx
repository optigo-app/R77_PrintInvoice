...
import "../../assets/css/prints/InvoicePrint1MaterialPurchase.css";
...
const InvoicePrintMaterialPurchase = ({
    token,
    invoiceNo,
    printName,
    urls,
                ...
                <>
                        ...
                        <div className="container_inv2">
                            ...
                            <div className="disflx brbxAll spfnthead spacTpm">
                                <div className="w1_invold">
                                    ...
                                    {json0Data?.customerregion !== '' && (<div className="disflx spacLft1">{json0Data?.customerregion}</div>)}
                    ...
                    ${taxAmont?.tax1Amount === 0 && taxAmont?.tax2Amount === 0 && taxAmont?.tax4Amount === 0 && taxAmont?.tax5Amount === 0 && taxAmont?.SGSTTotalAmount === 0 && taxAmont?.CGSTTotalAmount === 0 ? "Sucol2_inv2" : "col2_inv2"} spfntBld`}>DESCRIPTION</div>
                            ...
                            <div className="disflx spfntbH spbrRht spbrlFt spveheit">
                                <div className="col1_inv2 spbrRht spfntCen spbrWord" style={{ paddingTop: "70px",paddingLeft: "0px",paddingRight: "0px" }}> RAW MATERIAL</div>
                            ...
                            <div className="sprmrk brbxAll spfntbH pgbrkIsd">
                                ...
                                {json0Data?.Declaration && (
                                    <div className="spinst" dangerouslySetInnerHTML={{ __html: json0Data?.declaration1, }}></div>
                                )}
                            </div>
                            ...
                            <div className="brbxAll spfntbH spbnkdtl spbrRht spacTpm pgbrkIsd">
                                ...
                                <div>PAN NO. :<span>{json0Data?.ComPanCard}</span></div>
...
export default InvoicePrintMaterialPurchase;
