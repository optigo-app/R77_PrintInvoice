...
import "../../assets/css/prints/detailprintpmemo.css";
...
const DetailPrintPMemo = ({ token, invoiceNo, printName, urls, evn, ApiVer }) => {
                            ...
                            e?.colorstone.map((ele, ind) => {
                              return (
                                <div className={`d-flex`} key={ind}>
                                  ...
                                  <p className={`col-2 text-end ${dp1lp && "fw-bold"} ${detailPrintK && "fw-bold paddingRightDetailPrint1"}`} >
                                    {NumberWithCommas(ele?.Amount, 2)}
                                  </p>
                                </div>
                              );
...
export default DetailPrintPMemo;
