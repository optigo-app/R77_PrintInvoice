...
import "../../assets/css/prints/retailInvoicePrint3.css";
            ...
            {loader ? (
                ...
                <div className="container containerRetailPrint mt-5 pad_60_allPrint">
                    ...
                    {/* company address */}
                    {
                        headerflag && (
                            <div className="mt-2 px-1 d-flex no_break">
                                <div className="col-6">
                                    {jsonData1?.CompanyFullName && (
                                        <h6 className="fw-bold">{jsonData1.CompanyFullName}</h6>
                                    )}

                                    {jsonData1?.CompanyAddress && (
                                        <p className="ft_12_retailPrint">{jsonData1.CompanyAddress}</p>
                                    )}

                                    {jsonData1?.CompanyAddress2 && (
                                        <p className="ft_12_retailPrint">{jsonData1.CompanyAddress2}</p>
                                    )}

                                    {(jsonData1?.CompanyCity ||
                                        jsonData1?.CompanyPinCode ||
                                        jsonData1?.CompanyState ||
                                        jsonData1?.CompanyCountry) && (
                                            <p className="ft_12_retailPrint">
                                                {jsonData1?.CompanyCity} {jsonData1?.CompanyPinCode}{" "}
                                                {jsonData1?.CompanyState}
                                                {jsonData1?.CompanyCountry && `(${jsonData1.CompanyCountry})`}
                                            </p>
                                        )}

                                    {(jsonData1?.CompanyTellNo || jsonData1?.CompanyTollFreeNo) && (
                                        <p className="ft_12_retailPrint">
                                            {jsonData1?.CompanyTellNo && `T ${jsonData1.CompanyTellNo}`}
                                            {jsonData1?.CompanyTellNo && jsonData1?.CompanyTollFreeNo && " | "}
                                            {jsonData1?.CompanyTollFreeNo &&
                                                `TOLL FREE ${jsonData1.CompanyTollFreeNo}`}
                                        </p>
                                    )}

                                    {(jsonData1?.CompanyEmail || jsonData1?.CompanyWebsite) && (
                                        <p className="ft_12_retailPrint">
                                            {jsonData1?.CompanyEmail}
                                            {jsonData1?.CompanyEmail && jsonData1?.CompanyWebsite && " | "}
                                            {jsonData1?.CompanyWebsite}
                                        </p>
                                    )}

                                    {/* {(jsonData1?.Company_VAT_GST_No ||
                                        jsonData1?.Company_CST_STATE ||
                                        jsonData1?.Company_CST_STATE_No ||
                                        jsonData1?.Pannumber) && (
                                            <p className="ft_12_retailPrint">
                                                {jsonData1?.Company_VAT_GST_No}
                                                {jsonData1?.Company_VAT_GST_No &&
                                                ...
                                                {jsonData1?.Pannumber && `PAN-${jsonData1.Pannumber}`}
                                            </p>
                                        )} */}
                                </div>
                                <div className="col-6">
                    ...
                    <div className="d-flex border mt-2 no_break">
                        <div className={`p-1 border-end  col-8`}>
                        ...
                        <div
                            className="col-8 p-1 position-relative"
                        ...
                        >
                            <div className="d-flex">
                                <div className="col-3">
                                    ...
                                    <p className="fw-bold ft_12_retailPrint">Gold in 24K</p>
                                    {jsonData1?.HSN_No && <p className="fw-bold ft_12_retailPrint">{jsonData1?.HSN_No_Label}</p>}

                                </div>
                                <div className="col-9">
                                    <p className="ft_12_retailPrint">{jsonData1?.InvoiceNo}</p>
                                    <p className="ft_12_retailPrint">{jsonData1?.EntryDate}</p>
                                    <p className="ft_12_retailPrint">{jsonData1?.MetalRate24K &&
                                        (jsonData1?.MetalRate24K).toFixed(2)}</p>
                                    {jsonData1?.HSN_No && <p className="ft_12_retailPrint">{jsonData1?.HSN_No}</p>}
            ...
            <div className="othersRetailPrint border-end d-flex justify-content-center align-items-center">
              <p className="fw-bold">Others</p>
                    ...
                    {dataFill.map((e, i) => {
                        ...
                        console.log("TCL: e?.metal", e?.metal)
                        return (
                            <>
                                <div
                                ...
                                >
                                    ...
                                    <div className="poductDiscriptionRetailPrint border-end p-1 border-bottom ">
                                        <p style={{ wordBreak: "normal" ,textAlign:"center"}}>
                                    ...
                                    <div className="materialDescriptionRetailPrint border-end">
                                        <div className="d-grid h-100">
                                            {e?.metal?.map((ele, ind) => {
                                                ...
                                                const firstPrimaryIdx = e?.metal?.findIndex(m => m?.IsPrimaryMetal === 1);
                                                return (
                                                    ind === firstPrimaryIdx && (
                                  ...
                                  {ele?.Wt !== 0
                                    ...
                                    : "0.00" }
                                            ...
                                            {e?.colorstone?.map((ele, ind) => {
                                                return (
                                                    <div className={`d-flex border-bottom`} key={ind}>
                                                        <div className={`${styles.Material} border-end p-1 d-flex align-items-center`} style={{ width: rate?"20.5%":"25.5%"}}  >
                                                            <p>
                                                                {ele?.MasterManagement_DiamondStoneTypeName}
                                                            </p>
                                                        </div>
                                                        <div className={`${styles.Qty} border-end p-1 d-flex align-items-center`} style={{ width: rate?"13%":"17%"}}  >
                                                            <p>{ele?.QualityName}</p>
                                                        </div>
                                            ...
                                            {e?.MakingAmount + e?.SettingAmount > 0 && (
                    ...
                    <div className="d-flex border-start border-end border-bottom no_break">
                        ...
                        <div className=" p-1 d-flex flex-column align-items-start justify-content-between p-1 border-end" style={{ width: "38.3%" }}>
                            ...
                            <div>
                                ...
                                <p className="fw-bold ft_12_retailPrint">
                                    {convertWithAnd(Number( finalD?.mainTotal?.total_amount /
                                    jsonData1?.CurrencyExchRate +
                                    ...
                                    jsonData1?.AddLess / jsonData1?.CurrencyExchRate, 2)
                                    )}{" "}only
                                </p>
                            </div>
                        </div>
                        <div className="py-1 text-end border-end ft_12_retailPrint" style={{ width: "19.5%" }}>
                            {jsonData1?.CashReceived !== 0 && <p className="fw-bold py-1   ft_12_retailPrint px-1">Recv. in Cash</p>}
                            {bank.length > 0 &&
                                bank.map((e, i) => {
                                    return (
                                        <p className="fw-bold py-1 ft_12_retailPrint px-1" key={i}>
                                            {e?.label}
                                        </p>
                                    );
                                })}
                        ...
                        <div className="  py-1 text-end ft_12_retailPrint border-end" style={{ width: "11.5%" }}>
                            {jsonData1?.CashReceived !== 0 && <p className="fw-bold py-1  ft_12_retailPrint px-1">
                                {NumberWithCommas(jsonData1?.CashReceived, 2)} {/** Amount That Receive In Cash */}
                            </p>}
                        ...
                        <div className="py-1 text-end border-end ft_12_retailPrint" style={{ width: "15.7%" }}>
                        ...
                        <div className=" py-1 text-end ft_12_retailPrint" style={{ width: "15%" }}>
                            {finalD?.allTaxes.length > 0 &&
                                finalD?.allTaxes.map((e, i) => {
                                    return (
                    ...
                    {footerflag && (
                        ...
                        <>
                            ...
                            {/* bank detail */}
                            <div className="word_break_normal_retail_print d-flex border-start border-end border-bottom no_break ft_12_retailPrint" style={{ minHeight: "100px" }}>

                                <div className="col-6 border-end d-flex flex-column justify-content-between p-2" style={{textAlign:"center"}}>
                                    <p>Signature</p>
                                    <p className="fw-bold">{jsonData1?.customerfirmname}</p>
                                </div>
                                <div className="col-6 d-flex flex-column justify-content-between p-2 " style={{textAlign:"center"}}>
                                    <p>Signature</p>
...
export default RetailOnlyPrint;
