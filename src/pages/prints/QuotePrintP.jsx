...
import { apiCall, checkMsg, fixedValues, formatAmount, handleImageError,  isObjectEmpty,  mergeMetals,
  mergeFindings } from '../../GlobalFunctions';
import { OrganizeDataPrint } from '../../GlobalFunctions/OrganizeDataPrint';
import Loader from '../../components/Loader';
import "../../assets/css/prints/quotePrintP.css";
import { cloneDeep } from 'lodash';

const QuotePrintP = ({ token, invoiceNo, printName, urls, evn, ApiVer }) => {
                        ...
                        <div className="tbrowdp10 h-100 " key={i}>
                          ...
                          <div className="tbcol7dp10 d-flex  flex-column justify-content-between ">
                            <div className="d-flex">
                              <div className="end_dp10 pr_dp10" style={{width:'41%'}}>
                                { (printWithPrice && e?.MakingChargeDiscount !== 0 ? `${fixedValues(e?.MakingChargeDiscount,2)} %` : formatAmount(e?.MaKingCharge_Unit))}
                              </div>
                              <div className="end_dp10 pr_dp10" style={{width:'59%'}}>
