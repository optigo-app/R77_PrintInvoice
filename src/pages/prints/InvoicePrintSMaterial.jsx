...
import style3 from "../../assets/css/prints/TaxInvoice5s.css";
        ...
        <>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <tbody style={{ marginBottom: "50px" }}>
              <tr>
                <td>
                  <div className="w-full flex d-none-print"  >
...
export default InvoicePrintSMaterial;
