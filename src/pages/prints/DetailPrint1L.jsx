...
import "../../assets/css/prints/detailPrint1L.css";
...
const DetailPrint1L = ({ token, invoiceNo, printName, urls, evn, ApiVer }) => {
  ...
  const loadData = (data) => {
    ...
    datas?.resultArray?.map((e) => {
      ...
      //       acc[key].Amount += colorstone?.Amount || 0;
      //     } else {
      //       acc[key] = { ...colorstone };
      //     }
        ...
        <div className="container containerDetailPrint1 pt-4 ">
          <div className="pad_60_allPrint">
            ...
            <div className="d-flex w-100 border-top recordDetailPrint1 lightGrey detailPrint1L_font_11">
              ...
              <div className={`diamondDetailPrint1l border-end`}>
              ...
              <div className={`metalGoldDetailPrint1l border-end `}>
                <div className="d-grid h-100">
              ...
              <div className={`stoneDetailsPrint1l border-end `}>
                <div className="d-grid h-100">
                  <div className="d-flex justify-content-center border-bottom ">
              ...
              <div className={`otherAmountDetailPrint1l border-end  border-bottom d-flex align-items-center justify-content-center flex-column`}>
                ...
                return (
                  <div key={i} className="recordDetailPrint1 detailPrint1L_font_11">
                    <div className="d-flex w-100">
                      ...
                      <div className={`diamondDetailPrint1l border-end position-relative pt-1 paddingLeftDetailPrint1 paddingRightDetailPrint1`}>
                      ...
                      <div className={`stoneDetailsPrint1l border-end position-relative pt-1 paddingLeftDetailPrint1 paddingRightDetailPrint1`}>
                        <div className="h-100 paddingBottomTotalDetailPrint1">
                            ...
                            e?.colorstone.map((ele, ind) => {
                              return (
                                <div className={`d-flex`} key={ind}>
                                  ...
                                  <p
                                    className={`col-2 text-end fw-bold paddingRightDetailPrint1`}
                                  >
                                    {NumberWithCommas(ele?.Amount, 2)}
                                  </p>
                                </div>
                    ...
                    {e?.Discount !== 0 &&
                      <div className="d-flex w-100">
                        ...
                        <div className={`diamondDetailPrint1l border-end position-relative border-bottom lightGrey`}>
                          <div className="d-grid"></div>
                        </div>
                        <div className={`metalGoldDetailPrint1l border-end position-relative border-bottom lightGrey`}></div>
                        <div className={`stoneDetailsPrint1l border-end position-relative border-bottom pt-1 lightGrey`}>
                          <div className="d-grid">
                            {e?.Discount !== 0 && (
                              <p className="p-1 text-end fw-bold paddingLeftDetailPrint1 paddingRightDetailPrint1">
                                Discount{" "}
                                {e?.Discount !== 0 && NumberWithCommas(e?.Discount, 2)} % @Total Amount
                              </p>
                            )}
                          </div>
                        </div>
                        <div className={`otherAmountDetailPrint1l border-end border-bottom lightGrey`}>
            ...
            <div className="d-flex w-100 border-bottom border-start recordDetailPrint1 detailPrint1L_font_11">
              ...
              <div className="cgstTotalDetailPrint1 text-end border-end paddingLeftDetailPrint1 paddingRightDetailPrint1 py-1">
                ...
                <p>{json0Data?.AddLess?.toFixed(2)}</p>
              </div>
            </div>
            {/* total */}
            <div className="d-flex w-100 recordDetailPrint1 lightGrey detailPrint1L_font_11">
              ...
              <div className={`diamondDetailPrint1l border-end position-relative border-bottom d-flex flex-column justify-content-center paddingLeftDetailPrint1 paddingRightDetailPrint1`}>
                <div className="d-flex">
                  <div className=" col-2">
                    <p className=""></p>
                  </div>
              ...
              <div className={`metalTotalDetailPrint1l border-end position-relative border-bottom d-flex flex-column justify-content-center`}>
                <div className="d-flex">
                  ...
                  <div className="col-3 text-end paddingRightDetailPrint1">
                    <p className="fw-bold">
                      {finalD?.mainTotal?.MetalAmount?.toFixed(2)}
                    </p>
                  </div>
                </div>
              </div>
              <div className={`stoneDetailsPrint1l border-end position-relative border-bottom d-flex flex-column justify-content-center paddingLeftDetailPrint1 paddingRightDetailPrint1`}>
                <div className="d-flex">
              ...
              <div className={`otherAmountDetailPrint1l border-end border-bottom d-table paddingLeftDetailPrint1 paddingRightDetailPrint1`}>
                ...
                <div className="col-4 pe-1">
                  ...
                  <div className="d-flex border-end">
                    <div className="border-start col-6 border-end position-relative summaryPadBotDetailPrint1 d-flex flex-column">
                      <div className="d-flex justify-content-between">
                        ...
                        <p className="px-1 pt-1">
                          {finalD?.mainTotal?.metal?.FineWt > 0 ? (fixedValues((finalD?.mainTotal?.metal?.FineWt - notGoldMetalWtTotal), 3)) : "0.00"} gm
                        </p>
                      </div>
                      {
                        MetShpWise?.map((e, i) => {
                          return <div className="d-flex justify-content-between" key={i}>
                            ...
                            <p className="px-1 pt-1"> {fixedValues(e?.metalfinewt, 3)} gm </p>
                          </div>
                        })
                      }
                      <div className="d-flex justify-content-between">
                    ...
                    <div className="col-6 position-relative summaryPadBotDetailPrint1  d-flex flex-column">
                      ...
                      <div className="d-flex justify-content-between">
                        <p className="fw-bold px-1 pt-1">{json0Data?.AddLess < 0 ? "Less" : "Add"}</p>
                        <p className="px-1 pt-1">
